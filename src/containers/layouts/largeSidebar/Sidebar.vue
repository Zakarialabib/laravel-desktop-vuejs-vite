    ...
    >
      <div ref="sidebarChild">
        ...
        >
          ...
          >
            <router-link class to="/app/sale_return/store">
              <i class="nav-icon i-Add-File"></i>
          ...
          >
            <router-link class to="/app/sale_return/list">
              <i class="nav-icon i-Files"></i>
        ...
        >
          ...
          >
            <router-link class to="/app/purchase_return/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('AddReturn')}}</span>
            </router-link>
          </li>
          ...
          >
            <router-link class to="/app/purchase_return/list">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{$t('ListReturns')}}</span>
            </router-link>
          </li>
      ...
      <!-- hrm -->
        ...
        >
          ...
          >
            <router-link class to="/app/People/Users">
              <i class="nav-icon i-Administrator"></i>
        ...
        >
          ...
          >
            <router-link class to="/app/settings/permissions">
